...
exports.getDocs = function (req, res, next) {
   ...
   if( req.query.filter ) req.query.filter = decodeURIComponent(req.query.filter);
   if( req.query.select ) req.query.select = decodeURIComponent(req.query.select);
   if( req.query.sort ) req.query.sort = decodeURIComponent(req.query.sort);
   if( req.query.populate ) req.query.populate = decodeURIComponent(req.query.populate);
   ...
   var operations = {
      data : function(cb) {
         var populate = ( req.query.populate ) ? eval( '(' + req.query.populate + ')' ) : {};
